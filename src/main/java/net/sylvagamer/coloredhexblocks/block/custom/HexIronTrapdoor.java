...
public class HexIronTrapdoor extends TrapdoorBlock implements BlockEntityProvider {
    ...
    public static class HexIronTrapdoorEntity extends BlockEntity {

        public static final int DEFAULT_COLOR = 16777215;
        public int color = DEFAULT_COLOR;

        public HexIronTrapdoorEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.HEX_IRON_TRAPDOOR_ENTITY,pos, state);
        }
        ...
        public static int getColor(BlockRenderView world, BlockPos pos) {
            if(world==null){
                return HexIronTrapdoorEntity.DEFAULT_COLOR;
            }
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if(blockEntity instanceof HexIronTrapdoorEntity hexBlockEntity){
