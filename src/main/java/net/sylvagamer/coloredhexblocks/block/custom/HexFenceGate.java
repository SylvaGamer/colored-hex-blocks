...
public class HexFenceGate extends FenceGateBlock implements BlockEntityProvider {
    public HexFenceGate(WoodType woodType, Settings settings) {
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new HexFenceGateEntity(pos, state);
    }

    public ItemStack pickBlock(BlockView world, BlockPos pos, ItemStack stack, boolean includeData){
        HexFenceGateEntity blockEntity = ModBlockEntities.HEX_FENCE_GATE_ENTITY.get(world,pos);
        int color = HexFenceGateEntity.DEFAULT_COLOR;
        if(blockEntity != null){
    ...
    public static class HexFenceGateEntity extends BlockEntity {

        public static final int DEFAULT_COLOR = 16777215;
        public int color = DEFAULT_COLOR;

        public HexFenceGateEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.HEX_FENCE_GATE_ENTITY,pos, state);
        }
        ...
        public static int getColor(BlockRenderView world, BlockPos pos) {
            if(world==null){
                return HexFenceGateEntity.DEFAULT_COLOR;
            }
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if(blockEntity instanceof HexFenceGateEntity hexBlockEntity){
