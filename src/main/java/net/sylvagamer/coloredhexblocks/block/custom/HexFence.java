...
public class HexFence extends FenceBlock implements BlockEntityProvider{
    ...
    public static class HexFenceEntity extends BlockEntity {

        public static final int DEFAULT_COLOR = 16777215;
        public int color = DEFAULT_COLOR;

        public HexFenceEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.HEX_FENCE_ENTITY,pos, state);
        }
        ...
        public static int getColor(BlockRenderView world, BlockPos pos) {
            if(world==null){
                return HexFenceEntity.DEFAULT_COLOR;
            }
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if(blockEntity instanceof HexFenceEntity hexBlockEntity){
