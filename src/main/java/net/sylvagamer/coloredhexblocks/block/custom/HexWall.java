...
public class HexWall extends WallBlock implements BlockEntityProvider {
    ...
    public static class HexWallEntity extends BlockEntity {

        public static final int DEFAULT_COLOR = 16777215;
        public int color = DEFAULT_COLOR;

        public HexWallEntity(BlockPos pos, BlockState state) {
            super(ModBlockEntities.HEX_WALL_ENTITY,pos, state);
        }
        ...
        public static int getColor(BlockRenderView world, BlockPos pos) {
            if(world==null){
                return HexWallEntity.DEFAULT_COLOR;
            }
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if(blockEntity instanceof HexWallEntity hexBlockEntity){
