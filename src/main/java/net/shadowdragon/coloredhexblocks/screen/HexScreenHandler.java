...
public class HexScreenHandler {
    public static final ScreenHandlerType<DyingStationScreenHandler> DYING_STATION_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, new Identifier(ColoredHexBlocks.MOD_ID, "dying_station_screen_handler"),
                    new ExtendedScreenHandlerType<>(DyingStationScreenHandler::new));
